...
#Mis archivos 
files = os.listdir("./19-04-26/")#Aca pones la carpeta donde tenes todos los archivos que queres fitear
files.sort() #Los ordena

#Crea los archivos log 
fit_log= open("./fit_peaks_26_Abril.log", "a+")

data_energy_list = [open("./L0_26_Abril.txt", "w+"), 
					open("./L1_26_Abril.txt", "w+"), 
					open("./L2_26_Abril.txt", "w+")] 
...
center=		[1.52816,1.53015,1.53214] #agrego más semillas de ser necesario
...
a= 877.541 
#########################################################################
yes=input(u"Ver los graficos? [y(1)/n(0)]")
