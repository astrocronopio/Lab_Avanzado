...
fit_log= open("./fit_peaks_09_Mayo_01.log", "a+")

data_energy_list = [open("./L0_09_Mayo_01.txt", "w+"), 
...
center=		[1.53171,1.533,1.5364] #agrego más semillas de ser necesario
amplitude=	[100,		100,			100	 ]
sigma= 		[0.00115, 	0.00115, 	0.015]
