...
data_energy_list = [open("./L0_09_Mayo_04_condesado.txt", "w+"), 
					open("./L1_09_Mayo_04_condesado.txt", "w+")] 
...
center=		[1.5347563,1.53262, 1.53447,1.53528,1.53618] #agrego más semillas de ser necesario
amplitude=	[500,		1000,		1000, 800,		1400,		3000	 ]
