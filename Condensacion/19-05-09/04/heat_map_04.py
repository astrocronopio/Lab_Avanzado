...
y, potencia = np.loadtxt("./19-05-09/04/potencia.txt", unpack=True)
...
for x in range(0,len(files)):
	...
	if x%5==0:
		ax[x].text(0.0,1.5312965, "{:.1f}".format(potencia[x]/2.1))#, rotation='vertical') 
	counter+=1
...
fig.text(0.4,0.91, "1.3x1.3 $\mu$m")
