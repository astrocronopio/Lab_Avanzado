...
data_energy_list = [open("./L0_09_Mayo_04_primera_zona.txt", "w+"), 
					open("./L1_09_Mayo_04_primera_zona.txt", "w+")]
					#open("./L2_09_Mayo_04_primera_zona.txt", "w+")] 
...
center=		[1.53307,1.53503,1.53562, 1.53447,1.53528,1.53618] #agrego más semillas de ser necesario
amplitude=	[500,		1000,		10000, 800,		1400,		3000	 ]
sigma= 		[0.00001115, 	0.000115, 	0.0005, 0.00001115, 	0.0000115, 	0.00005]
...
for filename in files:
	...
	if counter==4:
		filtro_total=filtro_3*filtro_2*negro
		...
		filtro_total=filtro_3*filtro_2*filtro_1*circulito
