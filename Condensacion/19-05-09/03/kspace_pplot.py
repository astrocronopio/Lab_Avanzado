...
filename = "./xspace/22_xs.txt"
spectrum = "./condensado/_98.txt"
...
plt.title("1.6x1.6 $\mu$m, 52.9 mW")

pixel_y=np.array([NA*(pixel-157) for pixel in pixel_y ])

fig=plt.pcolor(pixel_y,1239.8/x, data,cmap='jet')
#fig=plt.pcolor(pixel_y,x, data,cmap='jet')
